// First ajax call for left player card //
$('#form1').on('submit', (event)=> {
  ...
  $.ajax({
    ...
    (data)=>{
        ...
        // ajax call to get season averages //
        $.ajax({
...
// Form 2 ajax call for right player card, almost identical to first ajax call but variable names changed //
...
// Function to add team logo for left player card //
const addLogo = () => {
...
// Function to add team logo for right player card //
const addLogo2 = () => {
...
// Gif carousel functionality on click of next button //
$next.on('click', () => {
    $currentGif.hide()
...
// Gif carousel functionality on click of previous button //
$previous.on('click', () => {
  $currentGif.hide()
